...
import "./Style.css"
import { addUserInDatabase, createUserWithEmailPassword, signInWithGoogle,signInWithEmailPassword } from '../library/firebase'
import { useEffect, useState } from 'react';
import { handleErrorFromEmailLogin, isEmailValid } from '../utils/HelperFunctions';
...
useEffect(()=>{
  if(isSignupEnabled&&confirmPassword.length)
      setValidationError({
        ...validationError,
       confirmPassword: password!==confirmPassword?"Enter above password not same":""
      })
      // eslint-disable-next-line react-hooks/exhaustive-deps
},[confirmPassword])
    ...
    <div className='LoginPageContainer'>
      ...
      >
        ...
        <Input
            ...
            />
            {isSignupEnabled &&( <Input.Password
        ...
        className="width100" 
        onClick={onGoogleClickHandler}><GoogleOutlined /></Button>
     </Card>
    </div>
  )
}
